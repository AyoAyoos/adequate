...
training_args = TrainingArguments(
    output_dir="./bloom_augmented_results",
    eval_strategy="epoch",
    save_strategy="epoch",
    learning_rate=2e-5,
...
if __name__ == "__main__":
    ...
    # Final Save
    model.save_pretrained("./final_bloom_bert_augmented")
    tokenizer.save_pretrained("./final_bloom_bert_augmented")
    print("\n✅ Training Complete. Model saved to ./final_bloom_bert_augmented")    